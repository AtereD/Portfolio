...
const experience = {
  icon: '/assets/resume/badge.svg',title: 'My experience', description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati ipsa labore ex eaque minus reiciendis eum cum!',
  items: [
    {
...
const education = {
  icon: '/assets/resume/cap.svg', title: 'My education', description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati ipsa labore ex eaque minus reiciendis eum cum!',
  items: [
    {
              ...
              <div className='flex flex-col gap-[30px] text-center xl:text-left'>
                ...
                <ul className='grid grid-cols-1 lg:grid-cols-2 gap-[30px]'>
                  {experience.items.map((item, index)=> {
                    return <li key={index} className='bg-[#232329] h-[184px] py-6 px-10 flex flex-col justify-center items-center lg:items-start gap-1' >
