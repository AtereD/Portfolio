      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row justify-center items-center gap-8">
          ...
          <form
            ...
            method="POST"
            target="_blank"
            className="flex flex-col gap-6 md:p-6 bg-[#3a3045] rounded-xl py-8 px-5 lg:w-1/2 w-full"
          >
            <h3 className="text-text text-center text-3xl md:text-4xl">
              Let&apos;s work together!!
            </h3>
            ...
            {/* Message */}
            <Textarea
              className="h-[200px] bg-primary/50 placeholder:text-text/50"
            ...
            <Button
              size="md"
              className="max-w-40 text-text hover:bg-transparent hover:border hover:border-text"
              type="submit"
            >
              Send
            </Button>
